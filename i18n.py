STRINGS = {
    "en": {
        ...
        "btn_set_duress_pin": "Set Duress PIN",
        "btn_clear_duress_pin": "Clear Duress PIN",
        "duress_pin_set": "Duress PIN set. Using it will look like a successful check-in and silence reminders, but your real deadline will not move.",
        "duress_pin_cleared": "Duress PIN cleared.",
        "duress_pin_matches_true": "Duress PIN must be different from your regular PIN. Choose another:\n\n{dots}",
        "pin_confirm_duress_setup": "Enter your current PIN to set a duress PIN:\n\n{dots}",
        "pin_confirm_duress_clear": "Enter your current PIN to clear the duress PIN:\n\n{dots}",
        "pin_setup_duress": "Set a new 4-digit duress PIN:\n\n{dots}",
    ...
    "zh": {
        ...
        "btn_set_duress_pin": "设置胁迫 PIN 码",
        "btn_clear_duress_pin": "清除胁迫 PIN 码",
        "duress_pin_set": "胁迫 PIN 码已设置。使用它会显示签到成功并停止提醒,但不会延后真实截止时间。",
        "duress_pin_cleared": "胁迫 PIN 码已清除。",
        "duress_pin_matches_true": "胁迫 PIN 码必须与普通 PIN 码不同。请重新输入:\n\n{dots}",
        "pin_confirm_duress_setup": "请输入当前 PIN 码以设置胁迫 PIN 码:\n\n{dots}",
        "pin_confirm_duress_clear": "请输入当前 PIN 码以清除胁迫 PIN 码:\n\n{dots}",
        "pin_setup_duress": "设置新的4位胁迫 PIN 码:\n\n{dots}",
    ...
    "es": {
        ...
        "btn_set_duress_pin": "Establecer PIN de coacción",
        "btn_clear_duress_pin": "Eliminar PIN de coacción",
        "duress_pin_set": "PIN de coacción establecido. Al usarlo parecerá que el registro tuvo éxito y se silenciarán los recordatorios, pero tu límite real no cambiará.",
        "duress_pin_cleared": "PIN de coacción eliminado.",
        "duress_pin_matches_true": "El PIN de coacción debe ser distinto de tu PIN normal. Elige otro:\n\n{dots}",
        "pin_confirm_duress_setup": "Introduce tu PIN actual para establecer un PIN de coacción:\n\n{dots}",
        "pin_confirm_duress_clear": "Introduce tu PIN actual para eliminar el PIN de coacción:\n\n{dots}",
        "pin_setup_duress": "Establece un nuevo PIN de coacción de 4 dígitos:\n\n{dots}",
    ...
    "ru": {
        ...
        "btn_set_duress_pin": "Установить PIN принуждения",
        "btn_clear_duress_pin": "Удалить PIN принуждения",
        "duress_pin_set": "PIN принуждения установлен. При его использовании отметка будет выглядеть успешной и напоминания замолчат, но реальный дедлайн не изменится.",
        "duress_pin_cleared": "PIN принуждения удалён.",
        "duress_pin_matches_true": "PIN принуждения должен отличаться от обычного PIN. Выберите другой:\n\n{dots}",
        "pin_confirm_duress_setup": "Введите текущий PIN для установки PIN принуждения:\n\n{dots}",
        "pin_confirm_duress_clear": "Введите текущий PIN для удаления PIN принуждения:\n\n{dots}",
        "pin_setup_duress": "Задайте новый 4-значный PIN принуждения:\n\n{dots}",
